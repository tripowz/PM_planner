...
6. В API есть миграции с будущими датами относительно 2026-04-30, например после мая 2026 и до декабря 2026. Нужно проверить, это planned migrations, ошибочные timestamps или ветка разработки из будущего.
